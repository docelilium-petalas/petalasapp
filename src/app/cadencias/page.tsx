...
export default function CadenciasPage() {
  ...
  return (
    <AppLayout>
      <div className="min-h-screen bg-black text-foreground p-4 sm:p-6 pb-6 font-sans select-text">
                ...
                <div className="overflow-x-auto rounded-xl border border-border/10">
                  ...
                  <div className="flex flex-col gap-3 md:hidden p-3.5">
                    {filteredLeads.map((lead: CadenceLead) => {
                      ...
                      return (
                        <div key={lead.id} className="p-4 rounded-xl border border-border/20 bg-neutral-950/40 space-y-3">
                          <div className="flex justify-between items-start">
                            <div>
                              <span className="font-bold text-neutral-200 text-xs block">{lead.nome}</span>
                          ...
                          <div className="flex justify-between text-[11px] border-t border-border/10 pt-2.5">
                            <div>
                              ...
                              <span className="font-semibold text-neutral-300">Etapa {lead.etapaAtual} / {selectedCadence.etapas.length}</span>
                            </div>
                            {lead.status === 'ATIVO' && lead.proximoEnvio && (
                          ...
                          <div className="flex justify-end gap-2 border-t border-border/10 pt-2.5">
                            ...
                            <button
                              onClick={() => handleRemoveLead(lead.id)}
                              className="p-1.5 rounded-xl bg-neutral-900 border border-border/40 hover:border-rose-500 text-muted-foreground hover:text-rose-500 transition-all cursor-pointer inline-flex items-center justify-center"
                            >
                              <Trash2 className="w-3.5 h-3.5" />
                            </button>
                          </div>
