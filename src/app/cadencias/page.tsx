...
export default function CadenciasPage() {
  ...
  return (
    <AppLayout>
      <div className="min-h-screen bg-background text-foreground p-6 max-md:p-4 pb-24 font-sans select-text">
      ...
      {view === 'list' && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="p-4 rounded-2xl border border-border/30 bg-muted/30">
      ...
      {/* LOADING STATE */}
      {loading && view === 'list' && (
        <div className="flex flex-col items-center justify-center py-20 border border-border/20 rounded-2xl bg-card/20">
      ...
      {!loading && cadences.length === 0 && view === 'list' && (
        <div className="flex flex-col items-center justify-center text-center py-20 px-4 border border-border/20 rounded-2xl bg-card/20">
          ...
          <button
            onClick={handleOpenCreateModal}
            className="mt-4 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-card border border-border hover:border-primary/50 text-xs font-semibold text-neutral-300 transition-colors cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cadences.map(cadence => {
            ...
            return (
              <div
                key={cadence.id}
                className="group relative flex flex-col justify-between rounded-2xl border border-border/30 bg-card/20 hover:border-primary/30 transition-all duration-300 overflow-hidden shadow-sm"
              >
                {/* Accent status light */}
                ...
                <div className="p-5 flex-1">
                  ...
                  {/* Summary of Steps */}
                  <div className="bg-card/40 rounded-xl p-3 border border-border/10 mb-4 flex items-center justify-between text-xs">
                    <span className="text-muted-foreground font-medium">Etapas da régua</span>
                    <span className="font-bold text-neutral-200 bg-card border border-border/30 px-2 py-0.5 rounded-lg flex items-center gap-1">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center text-[10px]">
                    <div className="py-2 rounded-lg bg-card/20 border border-border/15">
                ...
                {/* Card Actions Footer */}
                <div className="px-5 py-3 bg-card/50 border-t border-border/20 flex items-center justify-between">
                  <button
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-muted text-muted-foreground hover:text-rose-400 transition-all cursor-pointer"
      ...
      {view === 'detail' && selectedCadence && (
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/20 pb-5">
            <div className="flex items-center gap-3">
              <button
                ...
                className="p-2 rounded-xl border border-border/40 bg-card/20 text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="p-4 rounded-2xl border border-border/30 bg-card/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            {/* TIMELINE OF STEPS */}
            <div className="lg:col-span-1 border border-border/30 rounded-2xl p-5 bg-card/20 space-y-4">
                ...
                {selectedCadence.etapas.sort((a, b) => a.ordem - b.ordem).map((etapa, idx) => {
                  ...
                  return (
                    <div key={etapa.id} className="relative text-xs">
                      ...
                      <div className="p-3.5 rounded-xl border border-border/20 bg-card/40 relative">
            ...
            <div className="lg:col-span-2 border border-border/30 rounded-2xl p-5 bg-card/20 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                {/* Lead Search Input */}
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-border bg-background/80 w-full sm:w-60 focus-within:border-primary transition-all">
              ...
              {loadingDashboard ? (
                ...
                <div className="overflow-x-auto rounded-xl border border-border/10">
                  <table className="w-full text-left border-collapse text-xs select-text">
                    <thead>
                      <tr className="border-b border-border/20 bg-card/40 text-muted-foreground uppercase font-bold text-[9px] tracking-wider">
                        ...
                        return (
                          <tr key={lead.id} className="hover:bg-muted/30 transition-colors">
                            ...
                            <td className="p-3 text-center">
                              <span className={`px-2 py-0.5 rounded text-[9px] font-bold border ${statusColors[lead.status] || 'bg-muted text-neutral-300 border-border/20'}`}>
          ...
          <div className="w-full max-w-3xl rounded-2xl border border-border/80 bg-card p-5 shadow-2xl z-10 flex flex-col max-h-[90vh] ocr-glass-strong animate-scale-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-border bg-muted/40 text-foreground text-xs focus:outline-none focus:border-primary transition-all placeholder:text-muted-foreground/60"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-border bg-muted/40 text-foreground text-xs focus:outline-none focus:border-primary transition-all"
                  >
              ...
              <div className="space-y-4 pt-3 border-t border-border/20">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-card border border-border hover:border-primary/50 text-xs font-semibold text-neutral-300 transition-colors cursor-pointer"
                  >
                    <Plus className="w-3.5 h-3.5 text-primary" />
                  ...
                  {etapas.map((etapa, index) => {
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-neutral-200 bg-card px-2 py-0.5 rounded border border-border/30">
                            Etapa {index + 1}
                          </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 items-end">
                          <div className="space-y-1">
                            ...
                            <div className="flex gap-2">
                              <input
                                ...
                                className="w-20 px-3 py-1.5 rounded-lg border border-border bg-muted/40 text-foreground text-xs focus:outline-none focus:border-primary transition-all text-center font-bold"
                              />
                              <select
                                value={etapa.prazoUnidade}
                                onChange={e => handleUpdateStepField(index, 'prazoUnidade', e.target.value)}
                                className="flex-1 px-3 py-1.5 rounded-lg border border-border bg-muted/40 text-foreground text-xs focus:outline-none focus:border-primary transition-all"
                              >
                          ...
                          <div className="space-y-1">
                            ...
                            <select
                              ...
                              className="w-full px-3 py-1.5 rounded-lg border border-border bg-muted/40 text-foreground text-xs focus:outline-none focus:border-primary transition-all"
                            >
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full px-3 py-2 rounded-lg border border-border bg-muted/40 text-foreground text-xs focus:outline-none focus:border-primary transition-all resize-y placeholder:text-muted-foreground/50"
                          />
                        </div>
            ...
            <div className="pt-4 border-t border-border/20 flex items-center justify-end gap-3 shrink-0">
              <button
                type="button"
                onClick={() => setModalOpen(false)}
                className="px-4 py-2 rounded-xl border border-border hover:bg-card text-xs font-bold text-neutral-300 transition-colors cursor-pointer"
              >
                Cancelar
              </button>
              <button
